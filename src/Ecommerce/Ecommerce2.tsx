    ...
    <div className="rounded-2xl shadow-md p-4 bg-white w-60">
      <div className="p-2 bg-indigo-100 rounded-full inline-block mb-3">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-1.5 7h13L17 13M9 21a1 1 0 100-2 1 1 0 000 2zm6 0a1 1 0 100-2 1 1 0 000 2z" />
        </svg>
      </div>
      <div className="w-full h-[40px]">
        <Bar data={miniBarData} options={miniBarOptions} />
      </div>
      <h4 className="text-xl font-semibold mt-2">$16.5k <span className="text-green-500 text-sm">↑</span></h4>
  ...
  return (
    <div className="flex flex-row gap-6 mt-6 mb-8 w-full h-full">
      ...
      <div className="bg-white w-[300px] h-[460px] rounded-md shadow-xl p-6 flex flex-col items-center gap-6">
        <h3 className="text-lg font-bold text-black mb-1 text-center">Sales Overview</h3>
      ...
      {/* Sales Card Box */}
      <div className="w-[100px] h-[100px] hover:scale-105 transition-transform duration-300 gap-6">
        <SalesCard />
      </div>

      <div className="w-[100px] h-[100px] hover:scale-105 transition-transform duration-300">
        <SalesCard />
      </div>
    </div>
  );
